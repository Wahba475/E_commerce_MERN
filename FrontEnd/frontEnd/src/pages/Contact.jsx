...
function Contact() {
  ...
  const contactMethods = [
    ...
    },
    {
      ...
      title: 'Address',
      detail: '123 Tech Street, Silicon Valley, CA 94105',
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {contactMethods.map((method, index) => (
              <div key={index} className="bg-white p-8 rounded-2xl shadow-lg text-center hover:shadow-xl transition-shadow">
                <div className="text-black mb-4 flex justify-center">{method.icon}</div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">{method.title}</h3>
                <p className="text-black font-medium mb-2">{method.detail}</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      required
                      rows={6}
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-black focus:border-transparent transition-colors bg-gray-50 focus:bg-white resize-none"
                  ...
                  <button
                    ...
                    className="w-full bg-black text-white py-4 px-6 rounded-lg hover:bg-gray-800 focus:ring-2 focus:ring-black focus:ring-offset-2 transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {isSubmitting ? (
            ...
            <div>
              ...
              <div className="bg-gray-100 rounded-2xl h-80 mb-8 flex items-center justify-center">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Free parking available in our building garage. Enter on Tech Street.</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-gradient-to-r from-black to-gray-800 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-white text-black px-8 py-4 rounded-lg font-medium text-lg hover:bg-gray-100 transition-colors">
              Call Now: +1 (555) 123-4567
            </button>
            <button className="border-2 border-white text-white px-8 py-4 rounded-lg font-medium text-lg hover:bg-white hover:text-black transition-colors">
              Live Chat Support
            </button>
          </div>
        </div>
